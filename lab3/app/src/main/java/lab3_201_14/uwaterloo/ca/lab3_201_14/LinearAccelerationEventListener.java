...
public class LinearAccelerationEventListener  implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent se){
        if(se.sensor.getType() == Sensor.TYPE_LINEAR_ACCELERATION) {
            ...
            stepCounter.inputData(smoothY, numOfDataPts); // FSM input
    ...
    public void screenOutput() {
        ...
        outputDisplacement.setText(String.format("%.2f",DisplacementManager.getX()) + " m, " + String.format("%.2f",DisplacementManager.getY()) + " m" + "\n" + String.format("%.2f",DisplacementManager.getXSteps()) + " steps, " + String.format("%.2f",DisplacementManager.getYSteps()) + " steps" );
    }
